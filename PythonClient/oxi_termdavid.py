...
if __name__ == '__main__':
    try:
        DAVIDtermenrich(listF = '/nfs/home/students/chit/Thesis/results/{}/oxi_genelist.txt'.format(data), bgF='/nfs/home/students/chit/Thesis/results/{}/oxi_bg.txt'.format(data), idType = 'ENSEMBL_GENE_ID', listName = 'oxidata{}'.format(data), category = 'abcd,BBID,BIOCARTA,COG_ONTOLOGY,INTERPRO,KEGG_PATHWAY,OMIM_DISEASE,PIR_SUPERFAMILY,SMART,SP_PIR_KEYWORDS,UP_SEQ_FEATURE,GOTERM_MF_FAT,GOTERM_CC_FAT,GOTERM_BP_FAT')
